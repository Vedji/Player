...
from PyQt5.QtWidgets import QInputDialog, QWidget, QApplication, QMainWindow
...
class MyWin(QMainWindow,Ui_MainWindow):
    ...
    def getfiles(self):
        ...
        self.flag = 0
        self.flajok = 0 #dlya previous and next
        self.itemflag = 0
        self.stolb = 0
        self.selitem = None
